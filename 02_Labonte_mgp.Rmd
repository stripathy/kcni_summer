...
Cell type deconvolution requires two components:
* A set of bulk tissue gene expression samples
* A set of marker genes per cell type that you want to estimate (these are often derived from single-cell RNAseq data)
...
The Marker Gene Profiles tool makes use of cell type specific marker genes that have been 
